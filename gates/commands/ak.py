...
from gates.functions.func_ak import auto_sho_async


@Client.on_message(filters.command('ak',prefixes=['.','!','/',',','-','$','%','#']))
async def ak_(_,message):
    ...
    alaa = f'''
<b>[<a href="https://t.me/Sinalgunrol">シ</a>] Command: <code>Akame</code>
[<a href="https://t.me/Sinalgunrol">シ</a>] Format: <code>/ak cc|month|year|cvv.</code>
[<a href="https://t.me/Sinalgunrol">シ</a>] Gateway: <code>Shopify $0.75 USD</code></b>
'''
...
'''
    ...
    if resultado == 'Charged':
        mensaje = 'Charged $0.75 USD'
        status = 'Approved'
        logo = '✅'
    elif resultado == 'No Match':
        mensaje = 'No Match'
        status = 'Approved'
        logo = '✅'
        ...
        status = 'Approved'
        logo = '✅'
    elif resultado == 'Street address and postal code do not match.':
        mensaje = 'Street address and postal code do not match.'
        status = 'Approved'
        logo = '✅'
    elif resultado == 'Your card was declined':
        mensaje = 'Your card was declined'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'card number is expired':
        mensaje = 'card number is expired'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'This transaction has been declined':
        mensaje = 'This transaction has been declined'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'This transaction has been declined':
        mensaje = 'This transaction has been declined'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'Your payment could not be processed at this time, please try again in a few minutes':
        mensaje = 'Your payment could not be processed at this time, please try again in a few minutes'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'Card number is incorrect':
        mensaje = 'Card number is incorrect'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'Card was declined':
        mensaje = 'Card was declined'
        status = 'Declined'
        logo = '❌'
