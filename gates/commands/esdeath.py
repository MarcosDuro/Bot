...
@Client.on_message(filters.command('ed',prefixes=['.','!','/',',','-','$','%','#']))
async def ed_(_,message):
    ...
    alaa = f'''
<b>[<a href="https://t.me/Sinalgunrol">シ</a>] Command: <code>Esdeath</code>
[<a href="https://t.me/Sinalgunrol">シ</a>] Format: <code>/ed cc|month|year|cvv.</code>
[<a href="https://t.me/Sinalgunrol">シ</a>] Gateway: <code>Shopify + Chase Orbital Gateway $9.31 USD</code></b>
'''
...
'''
    ...
    if resultado == 'Charged':
        mensaje = 'Charged $9.31 USD'
        status = 'Approved'
        logo = '✅'
    elif resultado == 'CVV2/CVC2 Failure':
        mensaje = 'CVV2/CVC2 Failure'
        status = 'Approved'
        logo = '✅'
    elif resultado == 'Credit Floor':
        mensaje = 'Credit Floor'
        status = 'Approved'
        logo = '✅'
    elif resultado == 'Invalid Transaction Type':
        mensaje = 'Invalid Transaction Type'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'Do Not Honor':
        mensaje = 'Do Not Honor'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'Call Voice Center':
        mensaje = 'Call Voice Center'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'Invalid Institution Code':
        mensaje = 'Invalid Institution Code'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'Invalid Credit Card Number':
        mensaje = 'Invalid Credit Card Number'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'Pickup':
        mensaje = 'Pickup'
        status = 'Declined'
        logo = '❌'
    elif resultado == 'Call Voice Center':
