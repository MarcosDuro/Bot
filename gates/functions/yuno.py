...
from gates.functions.func_yuno import auto_sho_async


@Client.on_message(filters.command('yu',prefixes=['.','!','/',',','-','$','%','#']))
async def yu_(_,message):
    ...
    alaa = f'''
<b>[<a href="https://t.me/Sinalgunrol">シ</a>] Command: <code>Yuno</code>
[<a href="https://t.me/Sinalgunrol">シ</a>] Format: <code>/yu cc|month|year|cvv.</code>
[<a href="https://t.me/Sinalgunrol">シ</a>] Gateway: <code>Shopify + Payeezy $17.95 USD</code></b>
'''
