...
async def auto_sho_async(cc,mes,ano,cvv):
	...
	link = 'https://www.phenomenalmedia.com/'
	...
	async with aiohttp.ClientSession(connector=conn) as session:
		...
		req1 = await session.post(url=f'https://moonmagic.com/cart/add.js',data=payload_1,timeout=aiohttp.ClientTimeout(total=5))

		print('pene')

		req3 = await session.get(url=f"https://moonmagic.com/checkout",timeout=aiohttp.ClientTimeout(total=5))
  ...
  "payment_session_scope": "www.moonmagic.com"
}
